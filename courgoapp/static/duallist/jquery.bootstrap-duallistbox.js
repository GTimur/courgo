...
;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      moveSelectedLabel: 'Перенести указанный',
      moveAllLabel: 'Перенести все',
      removeSelectedLabel: 'Вернуть указанный',
      removeAllLabel: 'Вернуть все',
      ...
      infoText: 'В списке {0}',                                                        // text when all options are visible / false for no info text
      infoTextFiltered: '<span class="label label-warning">Отфильтровано</span> {0} from {1}', // when not all of the options are visible due to the filter
      infoTextEmpty: 'Пустой список',                                                        // when there are no options present in the list
